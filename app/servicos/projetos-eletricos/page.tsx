...
export default function ProjetosEletricosPage() {
  return (
    <>
      ...
      <div className="sp-hero" style={{ background: 'linear-gradient(rgba(0,0,0,0.62),rgba(0,0,0,0.62)), url("/images/sections/projetos-complementares2.jpg") center/cover no-repeat' }}>
        <span className="sp-tag">Serviço</span>
        <h1>Projetos de Engenharia Elétrica</h1>
        <p>Projetos elétricos e complementares em BIM com ART CREA ativo — baixa e média tensão, SPDA, medição agrupada e PCI. Do levantamento técnico à entrega As Built.</p>
      </div>
      ...
      <main className="sp-body">
        ...
        <div className="sp-gallery">
          <img src="/images/portfolio/projeto-luna.jpg"                       alt="Complexo Luna — projeto elétrico BIM"           loading="lazy" />
          <img src="/images/services/projeto-eletrico.jpg"                    alt="Prancha técnica de projeto elétrico"            loading="lazy" />
          <img src="/images/portfolio/projeto-eletrico-vias-do-atlantico.jpg" alt="Vias do Atlântico — projeto elétrico comercial" loading="lazy" />
        </div>
