...
export default function FotovoltaicaPage() {
  return (
    <>
      ...
      <div className="sp-hero" style={{ background: 'linear-gradient(rgba(0,0,0,0.62),rgba(0,0,0,0.62)), url("/images/sections/geracao-fotovoltaica1.jpeg") center/cover no-repeat' }}>
      ...
      <main className="sp-body">
        ...
        <div className="sp-gallery">
          <img src="/images/sections/geracao-fotovoltaica1.jpeg" alt="Instalação de sistema solar fotovoltaico" loading="lazy" />
          <img src="/images/services/foto-paineis-solares.jpg"    alt="Painéis solares em operação"             loading="lazy" />
          <img src="/images/services/geracao-fotovoltaica3.jpeg"  alt="Sistema fotovoltaico On Grid instalado"  loading="lazy" />
        </div>
        ...
        <div className="sp-section">
          ...
          <div className="norm-badges">
            <span className="norm-badge">NBR 16690</span>
            <span className="norm-badge">NR-10</span>
            <span className="norm-badge">ABNT</span>
          </div>
        </div>
