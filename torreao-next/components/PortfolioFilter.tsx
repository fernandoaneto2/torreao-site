...
const CARDS = [
  { slug: 'complexo-luna', category: 'residencial', img: '/images/portfolio/projeto-luna.jpg', alt: 'Complexo Residencial Luna — projeto elétrico executivo', tag: 'Residencial', area: '8.500 m²', year: '2025', title: 'Complexo Residencial Luna', desc: 'Projeto elétrico executivo com medição agrupada e SPDA.', tags: ['Projeto BIM', 'Alta Tensão'] },
  { slug: 'porto-resort', category: 'residencial', img: '/images/portfolio/projeto-agrupamento.jpg', alt: 'Porto Resort — agrupamento de medição elétrica', tag: 'Residencial', area: '8.500 m²', year: '2023', title: 'Porto Resort', desc: 'Medição agrupada conforme padrão da concessionária.', tags: ['Agrupamento', 'Eficiência energética'] },
  { slug: 'residencial-multifamiliar', category: 'residencial', img: '/images/portfolio/projeto-predial-residencial.jpg', alt: 'Edifício residencial multifamiliar — agrupamento e SPDA', tag: 'Residencial', area: '12.000 m²', year: '2024', title: 'Edifício Multifamiliar', desc: 'Medição agrupada, SPDA e cabeamento estruturado.', tags: ['Projeto BIM', 'Laudo SPDA'] },
  { slug: 'arco-metropolitano', category: 'comercial', img: '/images/portfolio/iluminacao-publica1.jpeg', alt: 'Arco Metropolitano — iluminação pública viária', tag: 'Comercial', area: '2.000 m²', year: '2024', title: 'Iluminação Pública — Arco Metropolitano', desc: 'Sistema de iluminação viária com eficiência energética.', tags: ['Projeto BIM', 'Aterramento'] },
  { slug: 'vias-atlantico', category: 'comercial', img: '/images/portfolio/projeto-eletrico-vias-do-atlantico.jpg', alt: 'Vias do Atlântico — projeto elétrico executivo', tag: 'Comercial', area: '2.000 m²', year: '2024', title: 'Vias do Atlântico', desc: 'Projeto elétrico executivo para loteamento comercial.', tags: ['Projeto BIM', 'Subestação'] },
  ...
  { slug: 'projeto-predial', category: 'residencial', img: '/images/portfolio/projeto-predial-residencial.jpg', alt: 'Projeto elétrico predial residencial — NR-10', tag: 'Residencial', area: '2.000 m²', year: '2024', title: 'Projeto Predial', desc: 'Projeto elétrico completo com ART, As Built e NR-10.', tags: ['Projeto BIM', 'Conformidade NR-10'] },
  { slug: 'projeto-eletrico-cabeamento', category: 'comercial', img: '/images/portfolio/projeto-eletrico.jpg', alt: 'Projeto elétrico e cabeamento estruturado corporativo', tag: 'Comercial', area: '2.000 m²', year: '2024', title: 'Projeto Elétrico + Cabeamento', desc: 'Infraestrutura elétrica e TI para ambiente corporativo.', tags: ['Projeto BIM', 'Termografia'] },
