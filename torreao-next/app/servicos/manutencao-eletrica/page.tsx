...
export default function ManutencaoEletricaPage() {
  return (
    <>
      ...
      <div className="sp-hero" style={{ background: 'linear-gradient(rgba(0,0,0,0.62),rgba(0,0,0,0.62)), url("/images/sections/electrical-panel.jpg") center/cover no-repeat' }}>
      ...
      <main className="sp-body">
        ...
        <figure className="sp-img-block">
          <img src="/images/services/manutencao-1.jpg" alt="Manutenção elétrica industrial — Torreão Engenharia" loading="lazy" />
        </figure>
