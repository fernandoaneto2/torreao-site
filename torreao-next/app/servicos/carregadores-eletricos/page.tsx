...
export default function CarregadoresEletricosPage() {
  return (
    <>
      ...
      <div className="sp-hero" style={{ background: 'linear-gradient(rgba(0,0,0,0.62),rgba(0,0,0,0.62)), url("/images/sections/ev-charger.jpg") center/cover no-repeat' }}>
      ...
      <main className="sp-body">
        ...
        <figure className="sp-img-block">
          <img src="/images/services/carregadores-1.jpg" alt="Veículo elétrico em recarga — Torreão Engenharia" loading="lazy" />
        </figure>
