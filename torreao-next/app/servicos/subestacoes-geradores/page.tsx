...
export default function SubestacoesGeradoresPage() {
  return (
    <>
      ...
      <div className="sp-hero" style={{ background: 'linear-gradient(rgba(0,0,0,0.62),rgba(0,0,0,0.62)), url("/images/sections/substation.jpg") center/cover no-repeat' }}>
      ...
      <main className="sp-body">
        ...
        <figure className="sp-img-block">
          <img src="/images/services/subestacoes-1.jpg" alt="Transformador de alta tensão — Torreão Engenharia" loading="lazy" />
        </figure>
