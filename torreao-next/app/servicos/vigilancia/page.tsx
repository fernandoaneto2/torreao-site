...
export default function VigilanciaPage() {
  return (
    <>
      ...
      <div className="sp-hero" style={{ background: 'linear-gradient(rgba(0,0,0,0.62),rgba(0,0,0,0.62)), url("/images/sections/surveillance.jpg") center/cover no-repeat' }}>
      ...
      <main className="sp-body">
        ...
        <figure className="sp-img-block">
          <img src="/images/services/vigilancia-1.jpg" alt="Central de monitoramento com câmeras — Torreão Engenharia" loading="lazy" />
        </figure>
